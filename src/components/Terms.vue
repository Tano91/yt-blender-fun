<template>
    <div class="main">
        ...
        <p>These terms and conditions outline the rules and regulations for the use of YT Blender's Website, located at
            ytblender.com.</p>

        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use YT Blender
        ...
        <p>We employ the use of cookies. By accessing YT Blender, you agreed to use cookies in agreement with the YT
            Blender's Privacy Policy. </p>
        ...
        <p>Unless otherwise stated, YT Blender and/or its licensors own the intellectual property rights for all
            material on YT Blender. All intellectual property rights are reserved. You may access this from YT Blender
            for your own personal use subjected to restrictions set in these terms and conditions.</p>

        <p>You must not:</p>
        <ul>
            <li>Republish material from YT Blender</li>
            <li>Sell, rent or sub-license material from YT Blender</li>
            <li>Reproduce, duplicate or copy material from YT Blender</li>
            <li>Redistribute content from YT Blender</li>
        </ul>
        ...
        <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
            areas of the website. YT Blender does not filter, edit, publish or review Comments prior to their presence
            on the website. Comments do not reflect the views and opinions of YT Blender,its agents and/or affiliates.
            Comments reflect the views and opinions of the person who post their views and opinions. To the extent
            permitted by applicable laws, YT Blender shall not be liable for the Comments or for any liability, damages
        ...
        <p>YT Blender reserves the right to monitor all Comments and to remove any Comments which can be considered
        ...
        <p>You hereby grant YT Blender a non-exclusive license to use, reproduce, edit and authorize others to use,
        ...
        <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
            ...
            records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of YT
            Blender; and (d) the link is in the context of general resource information.</p>
        ...
        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
            you must inform us by sending an e-mail to YT Blender. Please include your name, your organization name,
        ...
        <p>No use of YT Blender's logo or other artwork will be allowed for linking absent a trademark license
            agreement.</p>
