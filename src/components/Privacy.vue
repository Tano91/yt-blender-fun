<template>
    <div class="main">
        <h1>Privacy Policy of YT Blender</h1>

        <p>YT Blender operates the ytblender.com website, which provides the SERVICE.</p>

        <p>This page is used to inform website visitors regarding our policies with the collection, use, and disclosure
            of Personal Information if anyone decided to use our Service, the YT Blender website.</p>
